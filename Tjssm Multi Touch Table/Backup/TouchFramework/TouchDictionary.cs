...
namespace TouchFramework
{
    ...
    /// </summary>
    public class TouchDictionary : Dictionary<int, Touch>
    {
        const int KEEP_NUMPOINTS = 15;

        public int prevTouchCount = 0;
        public int currTouchCount = 0;
        ...
        /// </summary>
        public PointF MoveCenter = new PointF(0f, 0f);
        ...
        /// </summary>
        public PointF ActionCenter = new PointF(0f, 0f);
        ...
        public new void Add(int touchId, Touch touch)
        {
        ...
        public new Touch this[int touchId]
        {
            get
            {
                return base[touchId];
